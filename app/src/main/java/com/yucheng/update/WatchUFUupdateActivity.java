...
public class WatchUFUupdateActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String deviceVal = (String) UserSPHelperTwo.get(WatchUFUupdateActivity.this, "devicename", "no");
        macVal = deviceVal.split("/")[1];
    ...
    private void dfuInit(){
        ...
        mDfuAdapter =  GattDfuAdapter.getInstance(WatchUFUupdateActivity.this);
...
//            Log.e("TimeSetActivity","...progress......44");
        ...
        public void onError(int type, int code) {
            ...
            String message = DfuHelperImpl.parseError(WatchUFUupdateActivity.this, type, code);
